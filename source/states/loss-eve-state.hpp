...
class Lossevestate: public our::State {
    ...
    std::array<LossEveButton, 2> buttons;
    ...
    void onInitialize() override {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/loss-eve.jpg");
        ...
        buttons[0].position = {100.0f, 220.f};
        buttons[0].size = {600.0f, 100.0f};
        buttons[0].action = [this](){this->getApp()->changeState("menu");};

        buttons[1].position = {1000.0f, 650.0f};
