...
class Losswallestate: public our::State {
    ...
    std::array<LossWallEButton, 2> buttons;
    ...
    void onInitialize() override {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/loss-wall-e.jpg");
